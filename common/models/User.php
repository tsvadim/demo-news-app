...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            ['status', 'default', 'value' => self::getDefaultStatus()],
    ...
    /**
     * Установть блокировку пользователя
     */
    ...
    /**
     * Возвращает Полное имя или login(username)
     * @return string
     */
    ...
    public static function getStatuses()
    {
        return [
            ...
            static::STATUS_INACTIVE  => Yii::t('app', 'In activate'),
